...
<div class="p-policy__main-container">
        <div class="p-policy__container">

            <h2 class="p-policy__title">利用規約</h2>
            <p class="p-policy__text">この利用規約（以下、「本規約」といいます。）は、Crypto Trend
                （以下、「当サイト」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。</p>
            ...
            <h3 class="p-policy__title--sub">第4条（利用料金および支払方法）</h3>
            <p class="p-policy__text">
                ユーザーは，本サービスの有料部分の対価として，当社が別途定め，本ウェブサイトに表示する利用料金を，当社が指定する方法により支払うものとします。
            </p>

            <h3 class="p-policy__title--sub">第5条（禁止事項）</h3>
            ...
            <h3 class="p-policy__title--sub">第6条（本サービスの提供の停止等）</h3>
            <ol class="p-policy__list">
            ...
            <h3 class="p-policy__title--sub">第7条（利用制限および登録抹消）</h3>
            <p class="p-policy__text"></p>
            <ol class="p-policy__list">
            ...
            <h3 class="p-policy__title--sub">第8条（退会）</h3>
            <p class="p-policy__text">
                ユーザーは、当サイトの定める退会手続により、本サービスから退会できるものとします。
            </p>
            <h3 class="p-policy__title--sub">第9条（保証の否認および免責事項）</h3>
            <ol class="p-policy__list">
            ...
            <h3 class="p-policy__title--sub">第14条（権利義務の譲渡の禁止）</h3>
            <p class="p-policy__text">
